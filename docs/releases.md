...
The release workflow calls the existing CLI compatibility gate before creating
a release. Merging the release PR creates a `v<version>` GitHub release and builds
