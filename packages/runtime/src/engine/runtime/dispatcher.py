    ...
    async def dispatch(self, command: Command) -> None:
        ...
        match command:
            ...
            case StartAgentRun():
                ...
                # nothing callable and has nothing to announce. `AgentSession`
                # refuses such a profile outright rather than run it
                # (`UnknownToolGrantError`); dispatch has no equivalent, and
                # until it does, silence is the lesser of the two failures --
                # an agent told it holds a tool nobody served reaches for it
                # and gets nowhere.
